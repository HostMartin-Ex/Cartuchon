		...
		<nav class="navbar navbar-dark special-color-dark">
		  <a class="navbar-brand" href="#">
			<img src="img\LOGO.png" height="30" class="d-inline-block align-top"
			  alt="mdb logo"> Insertar TINTAS,CARTUCHOS y TONER
		  </a>
	...
	<div class="container">
		<div class="row pt-4">
			<div class="col-lg-6 col-sm-12">
				<form action="insertar.php" method="post" class="border border-light p-5">

					<p class="h4 mb-4 text-center">Insertar cartucho</p>
			...
			<div class="col-lg-6 col-sm-12">
				<form action="insertar_tinta.php" method="post" class="border border-light p-5">
					...
					<p class="h4 mb-4 text-center">Insertar tinta</p>
		...
		<div class="row pt-4">
			<div class="col-lg-6 col-sm-12">
				<form action="insertar_toner.php" method="post" class="border border-light p-5">
					...
					<p class="h4 mb-4 text-center">Insertar toner</p>
